...
URL.fund = 'https://github.com/Tacook-byte/FundSpider';
URL.gitHub = 'https://github.com/Tacook-byte';
URL.BiliBili = 'https://space.bilibili.com/450443708';
URL.email = 'https://Tacook602@gmail.com';
...
接下来我们就可以部署到免费的 Github Pages 上。我们在 Github 上新建一个仓库，这里我取得仓库名为`Tacook-byte.github.io`，注意建好自己的仓库都应该是(你的用户名.github.io)
...
git push -f git@github.com:Tacook-byte/Tacook-byte.github.io.git main
